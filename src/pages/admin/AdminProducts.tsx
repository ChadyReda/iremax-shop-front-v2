  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 style={{ fontFamily: 'Cormorant Garamond, serif' }} className="text-3xl font-normal">
            Products
          </h1>
      ...
      {isLoading ? <Spinner full /> : (
        <>
          <div className="bg-white border border-stone-100 overflow-x-auto">
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-stone-50 transition-colors">
                      ...
                      <td className="px-4 py-3 font-medium">
                        {fmt(p.price)}
                        {p.compareAtPrice && <span className="text-xs text-stone-400 line-through ml-1">{fmt(p.compareAtPrice)}</span>}
                      </td>
                      <td className="px-4 py-3">
                        <span className={`font-medium ${stock === 0 ? 'text-red-500' : stock <= 5 ? 'text-amber-600' : 'text-stone-700'}`}>
                          {stock}
                        </span>
                        <span className="text-xs text-stone-400 ml-1">units</span>
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          <button onClick={() => openEdit(p)} className="p-2 text-stone-400 hover:text-stone-900 transition-colors">
                            <Edit2 size={14} />
                          </button>
                          <button
            ...
            {!data?.data.length && <div className="p-10 text-center text-stone-400 text-sm">No products found.</div>}
          </div>
...
function ProductModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-end animate-fade-in">
      <div className="bg-white w-full max-w-2xl h-screen overflow-y-auto animate-slide-in">

        {/* Header */}
        <div className="flex items-center justify-between px-6 py-5 border-b border-stone-100 sticky top-0 bg-white z-10">
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif' }} className="text-xl font-medium">
        ...
        <div className="px-6 py-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`input ${errors.sku ? 'input-err' : ''}`}
          ...
          <div>
            ...
            <select
              ...
              className={`input appearance-none ${errors.categoryId ? 'input-err' : ''}`}
            >
          ...
          <div>
            ...
            <input
              ...
              className={`input ${errors.shortDescription ? 'input-err' : ''}`}
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className={`input resize-none ${errors.description ? 'input-err' : ''}`}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {imageUrls.map((url, i) => (
                <div key={i} className="relative w-20 h-24 bg-stone-100 overflow-hidden group">
                  ...
                  <button
                    ...
                    className="absolute top-1 right-1 bg-white/80 p-0.5 text-red-500 opacity-0 group-hover:opacity-100"
                  >
                    <X size={11} />
                  </button>
                </div>
            ...
            <label className="btn btn-outline btn-sm cursor-pointer gap-2 inline-flex">
              <Image size={14} />
