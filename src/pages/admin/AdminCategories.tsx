      ...
      <div className="bg-white border border-stone-100 overflow-x-auto">
        <table className="w-full text-sm min-w-[500px]">
          ...
          <tbody className="divide-y divide-stone-50">
            {cats?.map((cat) => (
              <tr key={cat.id || cat._id} className="hover:bg-stone-50">
                  ...
                  <div className="w-12 h-12 bg-stone-100 overflow-hidden">
                    {cat.imageUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <Image size={16} className="text-stone-300" />
                      </div>
                    )}
                  </div>
                </td>
...
function CategoryModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-end animate-fade-in">
      <div className="bg-white w-full max-w-md h-screen flex flex-col animate-slide-in">
        ...
        <div className="px-6 py-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            ...
            {/* Preview */}
            {preview && (
              <div className="relative w-full h-36 bg-stone-100 overflow-hidden mb-3">
                <img
                  src={preview}
                  alt="Preview"
                  className="w-full h-full object-cover"
                ...
                <button
                  ...
                  className="absolute top-2 right-2 bg-white/80 p-1 text-red-500 hover:bg-white"
                >
                  <X size={14} />
                </button>
              </div>
